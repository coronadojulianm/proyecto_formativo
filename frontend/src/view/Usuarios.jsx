...
import Table from '../components/tables/Tableusuarios.jsx';
import {Button} from "@nextui-org/react";
import {UserIcon} from '../components/moleculas/UserIcon.jsx';
      ...
      <div className={`transition-transform duration-300 ${isSidebarOpen ? 'ml-64' : 'ml-0'}`}>
        <div className="p-4 mt-16 flex justify-center"> {/* mt-16 para compensar la altura del Navbar */}
          <div>
            ...
            <br />
            <Button color="success" className='mb-3' endContent={<UserIcon/>}>
              Registrar
            </Button>
